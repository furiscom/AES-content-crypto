                ...
                <table id="file" class="table striped">
                  <thead>
                    <tr>
                      ...
                      <th style="color:#fff;">Nama File Enkripsi</th>
                      <th style="color:#fff;">Ukuran File</th>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($data['status'] == 1) { ?>
                            <a href="download_enkripsi.php?id_file=<?php echo $data['id_file']; ?>" class="btn btn-warning">Download Enkripsi</a>
                          <?php } elseif ($data['status'] == 2) { ?>
                            <a href="download_dekripsi.php?id_file=<?php echo $data['id_file']; ?>" class="btn btn-success">Download Dekripsi</a>
                            <a href="download_enkripsi.php?id_file=<?php echo $data['id_file']; ?>" class="btn btn-warning">Download Enkripsi</a>
                          <?php } else { ?>
                            <span class="btn btn-danger">Data Tidak Diketahui</span>
                          <?php } ?>
                        </td>
                      </tr>
                    <?php
